...
/** Mobil `legal_texts_tr.dart` ile hizalı yasal metinler. */
...
export const kvkkText = `1. Veri sorumlusu
...
export const privacyText = `1. Giriş
...
export const termsText = `1. Taraflar ve konu
